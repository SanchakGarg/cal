...
export function parseTeamInput(raw: unknown, opts: { partial?: boolean } = {}) {
  ...
  return {
    ...
    websiteUrl: optStr(body, "websiteUrl", { max: 500 }),
    contactEmail: optStr(body, "contactEmail", { max: 200 }),
    contactPhone: optStr(body, "contactPhone", { max: 50 }),
    location: optStr(body, "location", { max: 200 }),
